...
int main(int argc, char *argv[])
{
    ...
    GeoDatabase geodb;
    geodb.load("/Users/arnav/Documents/PleasePleasePlease/C++/CS 32/Bruin Tour/mapdata.txt");
    
    Router router(geodb);
    TourGenerator tg(geodb, router);
    
    Stops stops;
    stops.load("/Users/arnav/Documents/PleasePleasePlease/C++/CS 32/Bruin Tour/stops.txt");
